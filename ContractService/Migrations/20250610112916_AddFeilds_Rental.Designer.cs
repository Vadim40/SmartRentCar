...
namespace ContractService.Migrations
{
    ...
    [Migration("20250610112916_AddFeilds_Rental")]
    partial class AddFeilds_Rental
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContractService.Models.DisputeMessage", b =>
                {
                    b.Property<int>("DepositDisputeId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ContractService.Models.Rental", b =>
                {
                    ...
                    b.Property<bool>("IsDisputeRequested")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("IsEarlyEndConfirmedByCompany")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("IsEarlyEndConfirmedByRenter")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("IsEndConfirmedByCompany")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("IsEndConfirmedByRenter")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("IsStartConfirmedByCompany")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("IsStartConfirmedByRenter")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ContractService.Models.RentalDocument", b =>
                {
                    ...
                    b.HasOne("ContractService.Models.Rental", "Rental")
                        .WithMany()
